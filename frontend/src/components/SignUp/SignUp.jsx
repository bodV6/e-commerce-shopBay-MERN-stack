        ...
        <div className=" bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className=" group flex justify-center relative w-full h-[40px] bg-blue-600 text-white text-sm font-medium py-2 px-4 border border-transparent rounded-md hover:bg-blue-700"
              >
                Submit
              </button>
            </div>
